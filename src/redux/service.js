...
export const serviceApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    searchUsers: builder.query({
      query: (query) => ({ url: `users/search/${query}`, method: "GET" }),
    }),
    followUser: builder.mutation({
      query: (id) => ({ url: `user/follow/${id}`, method: "PUT" }),
    ...
    addPost: builder.mutation({
      query: (data) => ({ url: "post", method: "POST", body: data }),
    ...
    allPost: builder.query({
      query: (page) => ({ url: `post?page=${page}`, method: "GET" }),
      providesTags: (result) =>
        result
          ? [
    ...
    likePost: builder.mutation({
      query: (id) => ({ url: `post/like/${id}`, method: "PUT" }),
    ...
    repost: builder.mutation({
      query: (id) => ({ url: `repost/${id}`, method: "PUT" }),
      invalidatesTags: ["User"],
    }),

    // Comments
    addComment: builder.mutation({
      query: ({ id, ...data }) => ({ url: `comment/${id}`, method: "POST", body: data }),
      invalidatesTags: ["User"],
    }),
    deleteComment: builder.mutation({
      query: ({ postId, id }) => ({ url: `comment/${postId}/${id}`, method: "DELETE" }),
